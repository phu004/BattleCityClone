		...
		view.sendMessage.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e) {
					...
					if(!view.messageField.getText().equals("")){
						model.addMessage("You : " + view.messageField.getText());
		...
		view.messageField.addKeyListener( new KeyAdapter(){
			public void keyPressed(KeyEvent e){
				/*if(helpMessageCount  > 0){
					model.addMessage("Hint��press tab key to switch bewteen play mode and conversation mode");
				...
				public void keyPressed(KeyEvent e){
					...
					if(e.getKeyCode()==e.VK_ENTER){
						if(!view.messageField.getText().equals("")){
							...
							view.messageField.requestFocus();
						}
					}
